...
#LGE_DEV_PORTING, [jongpil.yoon@lge.com], 2011-03-05, <cp wireless.ko system/lib/modules>
	mkdir -p $(TARGET_OUT)/lib
	mkdir -p $(KERNEL_MODULES_OUT) 
	-cp  -f $(KERNEL_OUT)/drivers/net/wireless/bcm4330/wireless.ko $(KERNEL_MODULES_OUT)
#LGE_DEV_END, [jongpil.yoon@lge.com], 2011-03-05, <cp wireless.ko system/lib/modules>
