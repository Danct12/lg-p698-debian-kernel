...
// LGE_DEV_PORTING GELATO_DS_S[edward1.kim@lge.com]_20110521
#define KEYPAD_BL_CURRENT 	15 //150mA
// LGE_DEV_PORTING GELATO_DS_E[edward1.kim@lge.com]_20110521
...
#else// LGE_DEV_PORTING GELATO_DS_[edward1.kim@lge.com]_20110521
	if(value == LED_OFF)
		ret = pmic_set_led_intensity(LED_KEYPAD, 0);
	else
		ret = pmic_set_led_intensity(LED_KEYPAD, KEYPAD_BL_CURRENT);
