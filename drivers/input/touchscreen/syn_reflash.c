...
#include "syn_fw_1818_16esd.h"
#include "syn_fw_1818_19.h"
#include "syn_fw_1818_13.h"
#include "syn_fw_1818_15esd.h"
#include "syn_fw_1818_15.h"
#include "syn_fw_1912.h"
#include "syn_fw_1818_B.h"
...
// LGE_DEV_PORTING GELATO_DS_S [ks82.jung@lge.com] 2011-05-17
// H/W PCB REVISION INFORMATION
#define PCB_REV_A	3	// F/W 1.6
#define PCB_REV_B	4	// F/W 1.6
#define PCB_REV_C	5	// F/W 1.7
#define PCB_REV_D	6
#define PCB_REV_E	7
...
// LGE_DEV_PORTING GELATO_DS_S [ks82.jung@lge.com] 2011-05-17
extern int pcb_version_check;
static void ts_set_fw_version(int pcb_rev_info);
...
static void ts_set_fw_version(int pcb_rev_info)
{
	switch(pcb_rev_info)
	{
		case PCB_REV_A :
		case PCB_REV_B :
			firmware = firmware_1818_15esd;
			file_size = sizeof(firmware_1818_15esd);
			printk("[T-Reflash] Rev A or B : firmware is upgrade from ver%d to ver8\n",fw_rev);
			break;
		case PCB_REV_C :
			firmware = firmware_1818_B;
			file_size = sizeof(firmware_1818_B);
			printk("[T-Reflash] Rev C : firmware is upgrade from ver%d to ver B\n",fw_rev);
			break;

		default :
			firmware = firmware_1818_B;
			file_size = sizeof(firmware_1818_B);
			printk("[T-Reflash :default] Rev 1.X : firmware is upgrade from ver%d to B\n",fw_rev);
			break;
	}
}
// LGE_DEV_PORTING GELATO_DS_E
...
static int check_ts_firmware(enum firmware_type type, int fw_revision)
{
	...
	case syn_1818:
		ts_set_fw_version(pcb_version_check);
		break;
	case syn_1912:
