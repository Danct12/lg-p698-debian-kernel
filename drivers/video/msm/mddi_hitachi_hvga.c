...
static void mddi_hitachi_lcd_set_window (int x, int y, int xres, int yres)
{
...
struct msm_fb_panel_data hitachi_panel_data0 = {
	...
	.set_rect = mddi_hitachi_lcd_set_window,// LGE_DEV_PORTING GELATO_DS_[edward1.kim@lge.com]_20110419
};
