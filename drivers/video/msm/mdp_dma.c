...
// LGE_DEV_PORTING GELATO_DS_[edward1.kim@lge.com]_20110419 : for esd
extern int mddi_hitachi_position(void);
...
// LGE_DEV_PORTING GELATO_DS_S, ks82.jung@lge.com [2011-05-09]
#if defined (CONFIG_FB_MSM_MDDI_HITACHI_HVGA) || \
		defined (CONFIG_FB_MSM_MDDI_AUO_HVGA) || \
		defined (CONFIG_FB_MSM_MDDI_AUO_HITACHI_HVGA)
			mddi_hitachi_position();
#endif
...
// LGE_DEV_PORTING GELATO_DS_S, ks82.jung@lge.com[2011-05-13]
#if 0
