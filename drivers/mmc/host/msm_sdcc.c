...
/* LGE_CHANGE_S, [jongpil.yoon@lge.com], 2011-05-27, <do not sleep for not disabling SDIO> */
#ifdef WLAN_RESET_GPIO
			if(host->plat->status_irq == gpio_to_irq(WLAN_RESET_GPIO)) {
				mmc->ios.clock = 0;
				mmc->ops->set_ios(host->mmc, &host->mmc->ios);
			}
#endif /*WLAN_RESET_GPIO*/
/* LGE_CHANGE_E, [jongpil.yoon@lge.com], 2011-05-27, <do not sleep for not disabling SDIO> */
		}
/* LGE_CHANGE_S 2011_05_31_FILESYSTEM*/
			/*
...
/* LGE_CHANGE_E 2011_05_31_FILESYSTEM*/
...
/* LGE_CHANGE_E, [jisung.yang@lge.com], 2010-05-04, <do not do for wifi> */
		 ...
		 */
		//LGE_DEV_PORTING GELATO_DS_S/sunkyo.park@lge.com/20110422/temp fix for wifi crash
		if (host->plat->sdiowakeup_irq)
