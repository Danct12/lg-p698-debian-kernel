...
#define ERRHANDLER_MAGIC                       'E'
#define ERRHANDLER_IOCTL_LEVEL1		_IOW(ERRHANDLER_MAGIC, 1, char[LGE_ERROR_MAX_ROW*LGE_ERROR_MAX_COLUMN] )
#define ERRHANDLER_IOCTL_LEVEL2		_IOW(ERRHANDLER_MAGIC, 2, char[LGE_ERROR_MAX_ROW*LGE_ERROR_MAX_COLUMN] )

#define	LGE_ERROR_MAX_ROW				35
#define	LGE_ERROR_MAX_COLUMN			45
